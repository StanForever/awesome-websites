...
* [https://parish.cv](https://parish.cv/) : Portfolio of Parish Khan, Senior Software Developer specializing in React, TypeScript, and frontend architecture. Built as an interactive code-editor-inspired interface.
